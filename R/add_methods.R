...
add_user_methods <- function()
{
    ...
    {
        Microsoft365R::make_basic_list(self, "drives", filter, n)
    })
    ...
    function(filter=NULL, n=Inf)
    {
        lst <- Microsoft365R::make_basic_list(self, "followedSites", filter, n)
        if(!is.null(n))
    ...
    function(filter=NULL, n=Inf)
    {
        lst <- Microsoft365R::make_basic_list(self, "joinedTeams", filter, n)
        if(!is.null(n))
    ...
    function(filter=NULL, n=Inf)
    {
        Microsoft365R::make_basic_list(self, "chats", filter, n)
    })
...
add_group_methods <- function()
{
    ...
    function(filter=NULL, n=Inf)
    {
        Microsoft365R::make_basic_list(self, "planner/plans", filter, n)
    })
