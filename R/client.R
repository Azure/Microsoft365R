...
#'
#' @param tenant For `business_onedrive`, `sharepoint_site` and `team`, the name of your Azure Active Directory (AAD) tenant. If not supplied, use the value of the `CLIMICROSOFT365_TENANT` environment variable, or "common" if that is unset.
...
#'
#' @return
#' For `personal_onedrive` and `business_onedrive`, an object of class `ms_drive`. For `sharepoint_site`, an object of class `ms_site`. for `team`, an object of class `ms_team`.
#' @seealso
...
#' odb$list_items()
#'
#' mysite <- sharepoint_site("https://mycompany.sharepoint.com/sites/my-site-name", tenant="mycompany")
#' mysite$get_drive()$list_items()
#'
#' myteam <- team("My Team", tenant="mycompany")
