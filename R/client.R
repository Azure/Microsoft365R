...
#'
#' Use `personal_onedrive` to access the drive for your personal account, and `business_onedrive` to access your OneDrive for Business. On first use, you will get a dialog box in your browser asking permission for the AzureR Graph app to access your information.
#'
