...
- You can limit the account to only the roles and permissions it needs for its specific task.
...
{
    remote_drive <- shared[[i]]$properties$parentReference$driveId
    path <- shared[[i]]$get_parent_path()
    name <- shared[[i]]$properties$name
